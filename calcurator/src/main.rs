    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    for &num in row {
                        if ui
                            .add_sized(
                                button_size,
                                egui::Button::new(egui::RichText::new(num).size(button_text_size)),
                            )
                            .clicked()
                        {
                            if num == "=" {
            ...
            if ui
                .add_sized(
                    button_size,
                    egui::Button::new(egui::RichText::new("Clear").size(button_text_size)),
                )
                .clicked()
            {
            ...
            ui.label(
                egui::RichText::new(format!(
                    "Memory usage: input = {} bytes, result = {} bytes",
            ...
            ui.label(
                egui::RichText::new(format!(
                    "Dynamic memory size: input = {} bytes, result = {} bytes",
                    input_dynamic_size, result_dynamic_size
                ))
                .size(16.0),
            );
        });
